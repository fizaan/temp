...
public class Logit {
	...
	public static final boolean WRTOFILE = false;
	...
	public static FileWriter VRAMWR, VRAMWR_NO_ZERO,
			...
			ROMR, STATE, STACK, VRAMCOMPLETE, CTRL_REG;
	...
	static {
		try {
			...
			CTRL_REG = new FileWriter(System.getProperty("user.dir") +
					"\\logs\\ctrlReg.log");
	...
	public static void wrCTRL(String s) {
		if(!WRTOFILE) return;
		try {
			CTRL_REG.write(s);
			CTRL_REG.write("\n");
