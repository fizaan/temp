...
public class Bit {
	...
	public static void checkRange(int c) throws LC3VMException {
		String[] vmoptions=System.getenv("vmtoptions").split(",");
		String option3 = vmoptions[2];
		if(option3.equals("noMemViolationCheck")) return;
		if(c < 0x3000)
			throw new LC3VMException("Operating system memory violation: " +
					String.format("%04X",c));
	}
